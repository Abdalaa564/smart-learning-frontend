...
export class CallService {
  ...
  createMeeting(startsAt: string, description: string): Observable<any> {
    const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..kdE7qtocmY_cmcHlCWiV2r9tMKLqk9mZnNdc_cG6JyI';
